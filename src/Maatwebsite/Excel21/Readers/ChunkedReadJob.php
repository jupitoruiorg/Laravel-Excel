...
namespace Maatwebsite\Excel21\Readers;

use Illuminate\Bus\Queueable;
use Illuminate\Contracts\Queue\ShouldQueue;
use Maatwebsite\Excel21\Filters\ChunkReadFilter;
...
class ChunkedReadJob implements ShouldQueue
{
    ...
    {
        $reader = app('excel21.reader');
        $reader->injectExcel(app('phpexcel21'));
        ...
        $reader->excel21 = $reader->reader->load($this->file);
