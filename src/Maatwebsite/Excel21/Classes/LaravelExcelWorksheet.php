<?php namespace Maatwebsite\Excel21\Classes;
...
use Maatwebsite\Excel21\Writers\CellWriter;
...
class LaravelExcelWorksheet extends PHPExcel_Worksheet {
    ...
    public function __construct(PHPExcel $pParent = null, $pTitle = 'Worksheet')
    {
        ...
        $this->autoGenerateHeading = config('excel21.export.generate_heading_by_indices', true);
    }
    ...
    public function setDefaultPageSetup()
    {
        ...
        foreach ($this->allowedPageSetup as $setup)
        {
            ...
            // get the value
            $value = config('excel21.sheets.pageSetup.' . $setup, null);
        ...
        $this->setPageMargin(config('excel21.export.sheets.page_margin', false));
    }
    ...
    {
        return $this->parser = $parser ? $parser : app('excel21.parsers.view');
    }
    ...
    protected function _addVars($key, $value = false, $nullValue = null, $startCell = 'A1', $strictNullComparison = false)
    {
        ...
        if (is_array($key) || $key instanceof Collection)
        {
            ...
            // Create excel21 from array without a view
            if (!$this->parser)
            {
    ...
    public function getAutosize()
    {
        ...
        return config('excel21.export.autosize', true);
    }
    ...
    public function mergeCells($pRange = 'A1:A1', $alignment = false)
    {
        ...
        {
            $aligment = is_string($alignment) ? $alignment : config('excel21.export.merged_cell_alignment', 'left');
    ...
    {
        return config('excel21.export.sheets.nullValue', null);
    }
    ...
    {
        return config('excel21.export.sheets.startCell', 'A1');
    }
    ...
    {
        return config('excel21.export.sheets.strictNullComparison', false);
    }
